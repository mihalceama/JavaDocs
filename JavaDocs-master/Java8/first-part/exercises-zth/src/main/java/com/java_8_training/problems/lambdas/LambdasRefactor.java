...
//        });
        ...
        inventory.sort((Apple a1, Apple a2)-> {return a2.getWeight().compareTo(a1.getWeight());});
//        inventory.sort((Apple a1, Apple a2)-> a2.getWeight().compareTo(a1.getWeight()));
    ...
    public static List<Apple> filterGreenApples() {
        ...
        List<Apple> greenApples = filterApples(inventory, (a) -> a.getColor().equals(destColor));
