...
public class Student {
    ...
    public String toString() {
        return  "Student ID: " + this.getId() + " First name: " + this.getFirstName() + " Last name: " + this.getLastName() + " Average grade: " + this.getAverageGrade();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (student.getId() !=  this.getId() && student.getFirstName() != this.getFirstName() && student.getLastName() != this.getLastName() && student.getAverageGrade() != this.getAverageGrade())
            return false;
